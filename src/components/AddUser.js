...
function AddUser (props){
  ...
  const { result, uploader } = useDisplayImage();
   ...
   async function addemp(e){
    ...
    console.log(name,email,image,position,evaluator,password)
                ...
                <div className="form-group">
                  <div className="input-group">
                    <div className="custom-file">
                      ...
                      {result && <img class="img-size-50 mr-3 img-circle" ref={imageRef} src={result} alt="" />}
                                ...
                                <select className="form-control"   onChange={ (e) => setEvaluator(e.target.value)}>
                                <option  >select</option>
                                {props.evaluators !==" "?
      props.evaluators.map((evaluators,i) => (<>
        
                                    <option key={i} value={evaluators.id}>{evaluators.name}</option></>
                                    )): <option >No evaluators</option>
